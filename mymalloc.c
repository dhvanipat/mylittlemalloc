...
// just to make it more readable p much, like how i made some helper methods for malloc. but it's completely up to u how u want to split it. just keep it in mind bc it says we'll be graded on clarity
